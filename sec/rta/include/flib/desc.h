...
#define LDST_SRCDST_WORD_JOBDESCBUF_EFF	(0x45 << LDST_SRCDST_SHIFT)
#define LDST_SRCDST_WORD_SHRDESCBUF_EFF	(0x46 << LDST_SRCDST_SHIFT)
...
#define OP_ALG_AAI_RNG_SH_MASK	(0x03 << OP_ALG_AAI_RNG_SH_SHIFT)
#define OP_ALG_AAI_RNG_SH0	(0x00 << OP_ALG_AAI_RNG_SH_SHIFT)
#define OP_ALG_AAI_RNG_SH1	(0x01 << OP_ALG_AAI_RNG_SH_SHIFT)
...
#define NFIFOENTRY_PR			(1 << NFIFOENTRY_PR_SHIFT)

#define NFIFOENTRY_AST_SHIFT		14
#define NFIFOENTRY_AST_MASK		(1 << NFIFOENTRY_AST_SHIFT)
#define NFIFOENTRY_AST			(1 << NFIFOENTRY_AST_SHIFT)
