...
/* DESA family tests */
		ALG_OPERATION(OP_ALG_ALGSEL_DES, OP_ALG_AAI_ECB, 0, 0,
			      OP_ALG_ENCRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_DES,
			      WITH(OP_ALG_AAI_ECB | OP_ALG_AAI_CHECKODD), 0, 0,
			      OP_ALG_ENCRYPT);
...
/* AESA family tests */
		...
		ALG_OPERATION(OP_ALG_ALGSEL_AES,
			      WITH(OP_ALG_AAI_CBC | OP_ALG_AAI_DK), 0, 0,
			      OP_ALG_DECRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_AES, OP_ALG_AAI_CCM,
			      OP_ALG_AS_INITFINAL, 0, OP_ALG_DECRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_AES, OP_ALG_AAI_GCM,
			      OP_ALG_AS_INITFINAL, 0, OP_ALG_DECRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_AES,
			      WITH(OP_ALG_AAI_CCM | OP_ALG_AAI_C2K),
			      OP_ALG_AS_INITFINAL, 0, OP_ALG_DECRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_AES,
			      WITH(OP_ALG_AAI_GCM | OP_ALG_AAI_C2K),
			      OP_ALG_AS_INITFINAL, 0, OP_ALG_DECRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_AES, OP_ALG_AAI_XTS,
			      OP_ALG_AS_INITFINAL, 0, OP_ALG_DECRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_AES, OP_ALG_AAI_XCBC_MAC,
			      OP_ALG_AS_INITFINAL, 0, OP_ALG_DECRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_AES, OP_ALG_AAI_CTR_XCBCMAC,
			      OP_ALG_AS_INITFINAL, 0, OP_ALG_DECRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_AES, OP_ALG_AAI_CBC_XCBCMAC,
			      OP_ALG_AS_INITFINAL, 0, OP_ALG_ENCRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_AES, OP_ALG_AAI_CMAC,
			      OP_ALG_AS_INITFINAL, 0, OP_ALG_DECRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_AES, OP_ALG_AAI_CBC_CMAC,
			      OP_ALG_AS_INITFINAL, 0, OP_ALG_DECRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_AES, OP_ALG_AAI_CTR_CMAC,
			      OP_ALG_AS_INITFINAL, 0, OP_ALG_DECRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_AES, OP_ALG_AAI_CTR_CMAC_LTE,
			      OP_ALG_AS_INITFINAL, 0, OP_ALG_ENCRYPT);
...
/* ARC4 family tests */
		...
		ALG_OPERATION(OP_ALG_ALGSEL_ZUCE, OP_ALG_AAI_F8,
			      OP_ALG_AS_INITFINAL, ICV_CHECK_DISABLE,
			      OP_ALG_ENCRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_ZUCE, OP_ALG_AAI_F8,
			      OP_ALG_AS_INITFINAL, ICV_CHECK_DISABLE,
			      OP_ALG_DECRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_ZUCA, OP_ALG_AAI_F9,
			      OP_ALG_AS_INITFINAL, ICV_CHECK_DISABLE,
			      OP_ALG_ENCRYPT);
		ALG_OPERATION(OP_ALG_ALGSEL_ZUCA, OP_ALG_AAI_F9,
			      OP_ALG_AS_INITFINAL, ICV_CHECK_DISABLE,
